...
const webAppChannel = (typeof BroadcastChannel == 'function') ?
  new BroadcastChannel('sunrise-sw') : null;
    ...
    .then(windowClients => {
      ...
      for (let i = 0; i < windowClients.length; i++) {
        ...
        if (url.hash.includes(data.topic)) {
          // Found the Sunrise tab with the right topic open.
      ...
      // Found tab with Sunrise on a different topic,
      ...
      // Did not find a Sunrise browser tab. Open one.
