"use strict";
(self["webpackChunksunrise_webapp"] = self["webpackChunksunrise_webapp"] || []).push([["src_widgets_the-card-preview_jsx"],{
...
class TheCardPreview extends (react__WEBPACK_IMPORTED_MODULE_0___default().PureComponent) {
  ...
  render() {
    ...
    const fullName = sunrise_sdk__WEBPACK_IMPORTED_MODULE_5__.TheCard.getFn(card);
    const photoUrl = sunrise_sdk__WEBPACK_IMPORTED_MODULE_5__.TheCard.getPhotoUrl(card) || null;
    const note = card?.note;
    const org = sunrise_sdk__WEBPACK_IMPORTED_MODULE_5__.TheCard.getOrg(card);
    const emails = sunrise_sdk__WEBPACK_IMPORTED_MODULE_5__.TheCard.getComm(card, 'email') || [];
    const phones = sunrise_sdk__WEBPACK_IMPORTED_MODULE_5__.TheCard.getComm(card, 'tel') || [];
    const sunriseIds = sunrise_sdk__WEBPACK_IMPORTED_MODULE_5__.TheCard.getComm(card, 'tinode') || [];
    const urls = sunrise_sdk__WEBPACK_IMPORTED_MODULE_5__.TheCard.getComm(card, 'http') || [];
    const contacts = [];
