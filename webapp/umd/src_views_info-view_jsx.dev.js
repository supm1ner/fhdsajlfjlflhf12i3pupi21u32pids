"use strict";
(self["webpackChunksunrise_webapp"] = self["webpackChunksunrise_webapp"] || []).push([["src_views_info-view_jsx"],{
...
class InfoView extends (react__WEBPACK_IMPORTED_MODULE_0___default().Component) {
  ...
  handleImageChanged(mime, img) {
    ...
    this.props.onTopicDescUpdate(this.props.topic, new sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.TheCard(null, img || sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.Sunrise.DEL_CHAR), null);
  }
    ...
    switch (which) {
      ...
      case 'want':
        ...
        if (this.state.owner) {
          ...
          toSkip = sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.AccessMode.encode(sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.AccessMode.diff('ASDO', this.state.modeGiven));
  ...
  handleShare(e) {
    e.preventDefault();
    const card = new sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.TheCard(this.state.fullName, this.state.avatar, null, this.state.description);
    sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.TheCard.setTinodeID(card, sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.Sunrise.URI_TOPIC_ID_PREFIX + this.props.topic);
  ...
  handleContextMenu(params) {
    ...
    const isMe = this.props.sunrise.isMe(params.topicName);
    const menuItems = [{
  ...
  render() {
    ...
    return react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      ...
      uri: sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.Sunrise.URI_TOPIC_ID_PREFIX + this.props.topic,
      onCancel: this.handleBackNavigate
    }) : react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
