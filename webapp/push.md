...
* Locate `firebase-init.js` in the root folder of your copy of Sunrise app. Copy-paste the following keys from the configuration object to `firebase-init.js`: `apiKey`, `messagingSenderId`, `projectId`, `appId` (you may copy all keys).
...
* Copy Google-provided server key to `sunrise.conf`, see details [here](https://sunrise/chat/blob/master/docs/faq.md#q-how-to-setup-fcm-push-notifications).
