...
import { AccessMode, Sunrise, TheCard } from 'sunrise-sdk';
...
class InfoView extends React.Component {
  ...
  handleImageChanged(mime, img) {
    ...
    this.props.onTopicDescUpdate(this.props.topic, new TheCard(null, img || Sunrise.DEL_CHAR), null);
  }
  ...
  handleShare(e) {
    ...
    TheCard.setTinodeID(card, Sunrise.URI_TOPIC_ID_PREFIX + this.props.topic);
  ...
  render() {
    ...
    return (
      <div id="info-view">
        ...
        view == 'qrcode' ?
          <ShowQRCode
            uri={Sunrise.URI_TOPIC_ID_PREFIX + this.props.topic}
            onCancel={this.handleBackNavigate} />
          :
