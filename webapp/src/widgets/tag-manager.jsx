...
export default class TagManager extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      alias: Sunrise.tagByPrefix(this.props.tags, Sunrise.TAG_ALIAS) || '',
      tagInput: '',
  ...
  static getDerivedStateFromProps(nextProps, prevState) {
    ...
    if (!arrayEqual(tags, prevState.tags) && !prevState.activated) {
      return {
        tags: tags || [],
        alias: Sunrise.tagByPrefix(tags, Sunrise.TAG_ALIAS) || '',
      };
    }
    return null;
  }
  ...
  handleAddTag(tag) {
    const maxTagCount = this.props.sunrise.getServerParam(Sunrise.MAX_TAG_COUNT, MAX_TAG_COUNT);
  ...
  handleSubmit() {
    ...
    tags = Sunrise.setUniqueTag(tags, this.state.alias);
  ...
  render() {
    const minTagLength = this.props.sunrise.getServerParam(Sunrise.MIN_TAG_LENGTH, MIN_TAG_LENGTH);
    const maxTagLength = this.props.sunrise.getServerParam(Sunrise.MAX_TAG_LENGTH, MAX_TAG_LENGTH);
