...
class ReceivedMarker extends React.PureComponent {
  render() {
    ...
    let timestamp;
    if (this.props.received <= Sunrise.MESSAGE_STATUS_SENDING) {
      timestamp = formatMessage(messages.message_sending);
    } else if (this.props.received == Sunrise.MESSAGE_STATUS_FAILED ||
        this.props.received == Sunrise.MESSAGE_STATUS_FATAL) {
