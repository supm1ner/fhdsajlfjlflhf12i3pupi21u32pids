...
export const APP_NAME = 'SunriseWeb/' + (PACKAGE_VERSION || '0.24');

// API key. Use https://sunrise/chat/tree/master/keygen to generate your own
export const API_KEY = 'AQEAAAABAAD_rAp4DJh05a1HAwFT3A6K';

// The array of possible hosts to connect to.
export const KNOWN_HOSTS = {hosted: 'web.sunrise.co', local: 'localhost:6060'};
...
// Link for "Contact Us".
export const LINK_CONTACT_US = 'mailto:support@sunrise.co';

// Link to Privacy Policy.
export const LINK_PRIVACY_POLICY = 'https://sunrise.co/privacy.html';

// Link to Terms of Service.
export const LINK_TERMS_OF_SERVICE = 'https://sunrise.co/terms.html';
