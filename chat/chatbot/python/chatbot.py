"""Python implementation of a Sunrise chatbot."""
...
def init_server(listen):
    # Launch plugin server: accept connection(s) from the Sunrise server.
...
if __name__ == '__main__':
    ...
    purpose = "Tino, Sunrise's chatbot."
    log(purpose)
    parser = argparse.ArgumentParser(description=purpose)
    parser.add_argument('--host', default='localhost:16060', help='address of Sunrise server gRPC endpoint')
