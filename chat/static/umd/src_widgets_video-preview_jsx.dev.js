"use strict";
(self["webpackChunksunrise_webapp"] = self["webpackChunksunrise_webapp"] || []).push([["src_widgets_video-preview_jsx"],{
...
class VideoPreview extends (react__WEBPACK_IMPORTED_MODULE_0___default().PureComponent) {
  ...
  render() {
    ...
    return react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      ...
      ref: this.videoRef,
      autoPlay: autoPlay,
      src: this.props.sunrise.authorizeURL(this.props.content.url),
