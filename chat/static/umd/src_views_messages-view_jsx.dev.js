"use strict";
(self["webpackChunksunrise_webapp"] = self["webpackChunksunrise_webapp"] || []).push([["src_views_messages-view_jsx"],{
...
class LogoView extends (react__WEBPACK_IMPORTED_MODULE_0___default().PureComponent) {
  render() {
    const version = _config_js__WEBPACK_IMPORTED_MODULE_3__.APP_NAME + ' (' + sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.Sunrise.getLibrary() + ')';
    return react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      ...
      href: "https://sunrise/chat/"
    }, react__WEBPACK_IMPORTED_MODULE_0___default().createElement("img", {
      id: "logo",
      alt: "logo",
      src: "img/logo.svg"
    }), react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h2", null, "Sunrise Web")), react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", null, react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_intl__WEBPACK_IMPORTED_MODULE_1__.FormattedMessage, {
      id: "label_client",
      defaultMessage: [{
        "type": 0,
        "value": "Client:"
...
class MessagesView extends (react__WEBPACK_IMPORTED_MODULE_0___default().Component) {
  ...
  componentSetup(prevProps, prevState) {
    const topic = this.props.sunrise ? this.props.sunrise.getTopic(this.state.topic) : undefined;
    if (this.state.topic != prevState.topic) {
      if (prevState.topic && !sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.Sunrise.isNewGroupTopicName(prevState.topic)) {
  ...
  static getDerivedStateFromProps(nextProps, prevState) {
    ...
    if (!nextProps.topic) {
      ...
      const topic = nextProps.sunrise.getTopic(nextProps.topic);
      nextState = {
  ...
  leave(oldTopicName) {
    if (!oldTopicName || !this.props.sunrise.isTopicCached(oldTopicName)) {
      return;
    }
    const oldTopic = this.props.sunrise.getTopic(oldTopicName);
  ...
  handleDescChange(desc) {
    if (sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.Sunrise.isSelfTopicName(this.props.topic)) {
      this.setState({
    ...
    if (!this.readNotificationTimer) {
      this.readNotificationTimer = setInterval(_ => {
        ...
        while (this.readNotificationQueue.length > 0) {
          ...
          if (n.sendAt <= now) {
            this.readNotificationQueue.shift();
            if (n.seq == 0 || sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.Sunrise.isServerAssignedSeq(n.seq)) {
  ...
  handleMessageUpdate(msg) {
    ...
    if (status >= sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.Sunrise.MESSAGE_STATUS_SENT && msg.from != this.props.myUserId) {
      this.postReadNotification(msg.seq);
    }
  }
  ...
  handleFormResponse(action, text, data) {
    if (action == 'pub') {
      this.sendMessage(sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.Drafty.attachJSON(sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.Drafty.parse(text), data));
    } else if (action == 'url') {
    ...
    if (topic) {
      if (topic.isSelfType()) {
        ...
        if (acs && acs.isDeleter()) {
          ...
          if (!canDelete) {
            const maxDelAge = this.props.sunrise.getServerParam(sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.Sunrise.MSG_DELETE_AGE, 0) | 0;
    ...
    if (!msg && this.props.forwardMessage) {
      ...
      if (this.state.reply.editing) {
        ...
        if (typeof msg == 'string') {
          msg = sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.Drafty.parse(msg);
        }
        msg = sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.Drafty.append(sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.Drafty.sanitizeEntities(this.state.reply.content), msg);
      }
      this.handleCancelReply();
    }
  ...
  sendFileAttachment(file) {
    const maxInbandAttachmentSize = this.props.sunrise.getServerParam('maxMessageSize', _config_js__WEBPACK_IMPORTED_MODULE_14__.MAX_INBAND_ATTACHMENT_SIZE) * 0.75 - 1024 | 0;
    if (sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.TheCard.isFileSupported(file.type, file.name) || file.type == sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.TheCard.contentType) {
    ...
    if (file.size > maxInbandAttachmentSize) {
      ...
      const msg = sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.Drafty.attachFile(null, {
      ...
      (0,_lib_blob_helpers_js__WEBPACK_IMPORTED_MODULE_16__.fileToBase64)(file).then(b64 => this.sendMessage(sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.Drafty.attachFile(null, {
  ...
  sendTheCardAttachment(file, maxInbandAttachmentSize) {
    ...
    if (file.type == sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.TheCard.contentType) {
      this.sendMessage(sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.Drafty.appendTheCard(null, file.object));
      return true;
    }
    (0,_lib_blob_helpers_js__WEBPACK_IMPORTED_MODULE_16__.importVCard)(file).then(card => {
      this.sendMessage(sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.Drafty.appendTheCard(null, card));
    }).catch(err => {
  ...
  sendImageAttachment(caption, blob) {
    ...
    if (blob.size > maxInbandAttachmentSize) {
      ...
      (0,_lib_blob_helpers_js__WEBPACK_IMPORTED_MODULE_16__.imageScaled)(blob, _config_js__WEBPACK_IMPORTED_MODULE_14__.IMAGE_PREVIEW_DIM, _config_js__WEBPACK_IMPORTED_MODULE_14__.IMAGE_PREVIEW_DIM, -1, false).then(scaled => (0,_lib_blob_helpers_js__WEBPACK_IMPORTED_MODULE_16__.blobToBase64)(scaled.blob)).then(b64 => {
        let msg = sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.Drafty.insertImage(null, 0, {
          mime: mime,
        ...
        if (caption) {
          msg = sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.Drafty.appendLineBreak(msg);
          msg = sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.Drafty.append(msg, sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.Drafty.parse(caption));
        }
        this.sendMessage(msg, uploadCompletionPromise, uploader);
  ...
  sendVideoAttachment(caption, videoBlob, previewBlob, params) {
    ...
    if (videoBlob.size + previewBlob.size > maxInbandAttachmentSize) {
      uploader = this.props.sunrise.getLargeFileHelper();
      if (!uploader) {
        this.props.onError(this.props.intl.formatMessage(messages.cannot_initiate_upload));
        return;
      }
    ...
    if (uploads.length == 0) {
      Promise.all([(0,_lib_blob_helpers_js__WEBPACK_IMPORTED_MODULE_16__.blobToBase64)(videoBlob), (0,_lib_blob_helpers_js__WEBPACK_IMPORTED_MODULE_16__.blobToBase64)(previewBlob)]).then(b64s => {
        const [v64, i64] = b64s;
        let msg = sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.Drafty.insertVideo(null, 0, {
          mime: v64.mime,
          bits: v64.bits,
          preview: i64.bits,
          premime: i64.mime,
  ...
  sendAudioAttachment(url, preview, duration) {
    fetch(url).then(result => result.blob()).then(blob => {
      const maxInbandAttachmentSize = this.props.sunrise.getServerParam('maxMessageSize', _config_js__WEBPACK_IMPORTED_MODULE_14__.MAX_INBAND_ATTACHMENT_SIZE) * 0.75 - 1024;
      if (blob.size > maxInbandAttachmentSize) {
        const uploader = this.props.sunrise.getLargeFileHelper();
        if (!uploader) {
          this.props.onError(this.props.intl.formatMessage(messages.cannot_initiate_upload));
        ...
        const uploadCompletionPromise = uploader.upload(blob);
        const msg = sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.Drafty.appendAudio(null, {
          mime: blob.type,
          size: blob.size,
          duration: duration,
          preview: preview,
        ...
        (0,_lib_blob_helpers_js__WEBPACK_IMPORTED_MODULE_16__.blobToBase64)(blob).then(b64 => {
          this.sendMessage(sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.Drafty.appendAudio(null, {
            mime: b64.mime,
            bits: b64.bits,
            size: blob.size,
            duration: duration,
  ...
  handlePickReply(seq, content, senderId, senderName) {
    ...
    content = typeof content == 'string' ? sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.Drafty.init(content) : content;
    if (sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.Drafty.isValid(content)) {
      content = sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.Drafty.replyContent(content, _config_js__WEBPACK_IMPORTED_MODULE_14__.QUOTED_REPLY_LENGTH);
    } else {
      content = sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.Drafty.append(sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.Drafty.init('\u26A0 '), sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.Drafty.wrapInto(this.props.intl.formatMessage(messages.invalid_content), 'EM'));
    }
    this.setState({
      reply: {
        content: sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.Drafty.quote(senderName, senderId, content),
        seq: seq
      }
    });
    this.props.onCancelForwardMessage();
  ...
  handleEditMessage(seq, content) {
    ...
    content = typeof content == 'string' ? sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.Drafty.init(content) : content;
    const editable = sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.Drafty.toMarkdown(content);
    if (sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.Drafty.isValid(content)) {
      content = sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.Drafty.replyContent(content, _config_js__WEBPACK_IMPORTED_MODULE_14__.EDIT_PREVIEW_LENGTH);
    } else {
      content = sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.Drafty.append(sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.Drafty.init('\u26A0 '), sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.Drafty.wrapInto(this.props.intl.formatMessage(messages.invalid_content), 'EM'));
    }
    this.setState({
      reply: {
        content: sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.Drafty.quote(this.props.intl.formatMessage(messages.editing_message), null, content),
        seq: seq,
        editing: true
      },
  ...
  render() {
    ...
    if (!this.state.topic) {
      ...
      if (this.state.imagePreview) {
        ...
        if (sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.TheCard.isFileSupported(this.state.docPreview.type, this.state.docPreview.name) || this.state.docPreview.type == sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.TheCard.contentType) {
          component2 = react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react__WEBPACK_IMPORTED_MODULE_0__.Suspense, {
            fallback: react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_intl__WEBPACK_IMPORTED_MODULE_1__.FormattedMessage, {
              id: "loading_note",
              defaultMessage: [{
        ...
        if (isChannel) {
          ...
          const cont = this.props.sunrise.getMeTopic().getContact(this.state.topic);
          if (cont) {
            if (sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.Sunrise.isP2PTopicName(cont.topic)) {
              if (cont.online) {
            ...
            } else if (sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.Sunrise.isGroupTopicName(cont.topic)) {
              if (topic.subcnt) {
...
class Attachment extends (react__WEBPACK_IMPORTED_MODULE_0___default().Component) {
  ...
  downloadFile(url, filename, mimetype) {
    ...
    const downloader = this.props.sunrise.getLargeFileHelper();
    this.setState({
...
class BaseChatMessage extends (react__WEBPACK_IMPORTED_MODULE_0___default().PureComponent) {
  constructor(props) {
    ...
    this.formatterContext = {
      ...
      authorizeURL: props.sunrise.authorizeURL.bind(props.sunrise),
  ...
  handleContextClick(e) {
    ...
    e.stopPropagation();
    const menuItems = [];
    if (this.props.received == sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.Sunrise.MESSAGE_STATUS_FAILED) {
      menuItems.push('menu_item_send_retry');
    }
    if (this.props.received > sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.Sunrise.MESSAGE_STATUS_FATAL) {
      if (this.props.userIsWriter) {
        menuItems.push('menu_item_reply');
        if (!this.props.response) {
          let immutable = false;
          sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.Drafty.entities(this.props.content, (_0, _1, tp) => {
            immutable = ['AU', 'EX', 'FM', 'IM', 'TC', 'VC', 'VD'].includes(tp);
            return immutable;
          });
          if (!immutable) {
            sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.Drafty.styles(this.props.content, tp => {
    ...
    if (this.props.mimeType == sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.Drafty.getContentType() && sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.Drafty.isValid(content)) {
      sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.Drafty.attachments(content, (att, i) => {
        ...
        attachments.push(react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_attachment_jsx__WEBPACK_IMPORTED_MODULE_3__["default"], {
          sunrise: this.props.sunrise,
          downloadUrl: sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.Drafty.getDownloadUrl(att),
          filename: att.name,
          uploading: sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.Drafty.isProcessing(att),
          mimetype: att.mime,
          size: sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.Drafty.getEntitySize(att),
      ...
      if (new RegExp('^\\p{RGI_Emoji}{1,5}$', 'v').test(content || '')) {
        ...
        content = react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, (0,_lib_formatters_js__WEBPACK_IMPORTED_MODULE_7__.highlightText)([content], this.props.highlightTerm, 'hl'));
      }
    } else {
...
class PinnedMessages extends (react__WEBPACK_IMPORTED_MODULE_0___default().PureComponent) {
  ...
  render() {
    ...
    messageShown = messageShown ? messageShown._deleted ? react__WEBPACK_IMPORTED_MODULE_0___default().createElement("i", {
      className: "gray"
    }, this.props.intl.formatMessage(messages.message_deleted)) : sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.Drafty.format(messageShown.content, _lib_formatters_js__WEBPACK_IMPORTED_MODULE_3__.previewFormatter, {
...
class ReceivedMarker extends (react__WEBPACK_IMPORTED_MODULE_0___default().PureComponent) {
  render() {
    ...
    let timestamp;
    if (this.props.received <= sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.Sunrise.MESSAGE_STATUS_SENDING) {
      timestamp = formatMessage(messages.message_sending);
    } else if (this.props.received == sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.Sunrise.MESSAGE_STATUS_FAILED || this.props.received == sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.Sunrise.MESSAGE_STATUS_FATAL) {
...
class SendMessage extends (react__WEBPACK_IMPORTED_MODULE_0___default().PureComponent) {
  ...
  formatReply() {
    return this.props.reply ? sunrise_sdk__WEBPACK_IMPORTED_MODULE_2__.Drafty.format(this.props.reply.content, _lib_formatters_js__WEBPACK_IMPORTED_MODULE_5__.replyFormatter, {
      formatMessage: this.props.intl.formatMessage.bind(this.props.intl),
      authorizeURL: this.props.sunrise.authorizeURL.bind(this.props.sunrise)
    }) : null;
  }
