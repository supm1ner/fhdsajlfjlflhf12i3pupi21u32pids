"use strict";
(self["webpackChunksunrise_webapp"] = self["webpackChunksunrise_webapp"] || []).push([["src_widgets_call-panel_jsx"],{
...
class CallPanel extends (react__WEBPACK_IMPORTED_MODULE_0___default().PureComponent) {
  ...
  createPeerConnection(withDataChannel) {
    const iceServers = this.props.sunrise.getServerParam('iceServers', null);
