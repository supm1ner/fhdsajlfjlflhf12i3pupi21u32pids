...
// PromExporter collects metrics in Prometheus format from a Sunrise server.
...
func NewPromExporter(server, namespace string, timeout time.Duration, scraper *Scraper) *PromExporter {
	return &PromExporter{
		...
		up: prometheus.NewDesc(
			...
			"If sunrise instance is reachable.",
			nil,
			nil,
		),
		version: prometheus.NewDesc(
			prometheus.BuildFQName(namespace, "", "version"),
			"The version of this sunrise instance.",
			nil,
			nil,
		),
...
// Collect fetches statistics from the configured Sunrise instance, and
