...
// Scraper collects metrics from a sunrise server.
type Scraper struct {
	// Target Sunrise server address.
	address string
...
// CollectRaw gathers all metrics from the configured Sunrise instance,
...
// Scrape fetches the data from Sunrise server using HTTP GET then decodes the response.
