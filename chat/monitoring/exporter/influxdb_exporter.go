...
// InfluxDBExporter collects metrics from a Sunrise server and pushes them to InfluxDB.
...
// Push scrapes metrics from Sunrise server and pushes these metrics to InfluxDB.
