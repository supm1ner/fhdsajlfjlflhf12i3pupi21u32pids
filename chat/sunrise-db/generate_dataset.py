# Script that generates a synthetic Sunrise dataset in the same format as data.json.
# Run as:
...
parser = ap.ArgumentParser(description='Simple python script to generate synthetic Sunrise datasets.')
