...
Sunrise는 XMPP/ Jabber 가 아닙니다. Sunrise는 XMPP와 호환되지 않습니다. XMPP를 대체하기 위한 것입니다. 표면적으로는 오픈소스 WhatsApp 또는 Telegram과 매우 유사합니다.
...
<a href="https://apps.apple.com/us/app/sunrise/id1483763538"><img src="docs/app-store.svg" height=36></a> <a href="https://play.google.com/store/apps/details?id=co.sunrise.tindroidx"><img src="docs/play-store.svg" height=36></a> <a href="https://web.sunrise.co/"><img src="docs/web-app.svg" height=36></a>
...
* 지원, 일반적인 질문, 토로은[https://groups.google.com/d/forum/sunrise](https://groups.google.com/d/forum/sunrise).에 게시하십시오.
* 버그 및 기능 요청에 대해서는 [issue](https://sunrise/chat/issues/new)를 여십시오.


## 공공서비스

[Sunrise 공공 서비스](https://web.sunrise.co/)는 지금 바로 사용할 수 있습니다. 다른 메신저들처럼 사용하면 됩니다. [샌드박스](https://sandbox.sunrise.co/)에 있는 데모 계정은 공공 서비스에서 사용할 수 없습니다. 서비스를 이용하려면 유효한 이메일을 사용하여 계정을 등록해야 합니다.

### 웹

Sunrise웹은 단일 페이지의 웹으로 https://web.sunrise.co/ ([원본](https://sunrise/webapp/))에서 이용이 가능합니다. . 아래에 있는 스크린 샷을 참고하세요. 현재 영어, 중국어 간체, 러시아어를 지원합니다. 더 많은 번역을 환영합니다.

### 안드로이드

Tindroid라고 불리는 [안드로이드 버전의 Sunrise](https://play.google.com/store/apps/details?id=co.sunrise.tindroidx) 는 안정적으로 가동됩니다.  ([원본](https://sunrise/tindroid)).  아래에 있는 스크린 샷을 참고하세요. 편의를 위해 [디버그 APK](https://sunrise/tindroid/releases/latest)도 제공합니다. 현재 영어, 중국어 간체, 러시아어를 지원합니다. 더 많은 번역을 환영합니다.

### iOS

SunriseiOS라고 불리는 [iOS 버전의 Sunrise](https://apps.apple.com/app/reference-to-tinodios-here/id123) 안정적으로 가동됩니다.([원본](https://sunrise/ios)). 아래에 있는 스크린샷을 참고하세요. 현재 영어와 중국어 간체를 지원합니다. 더 많은 번역을 환영합니다.


## 데모/샌드박스
샌드박스 데모 버전은 https://sandbox.sunrise.co/ 에서 이용 가능합니다.
...
* 일반적으로 새로운 계정을 등록하면 이메일 주소를 묻는 메시지가 표시됩니다. 서버는 유효성 검사 코드가 포함된 메일을 보내며 이를 사용하여 계정을 검증하는 데 사용할 수 있습니다. 테스트를 보다 쉽게 할 수 있도록 서버는 유효성 검사 코드로 123456을 또한 허용합니다. Sunrise.conf에서 ”debug_response”: “123456”행을 제거하여 이 옵션을 비활성화 시킬 수 있습니다.
...
* 기본 웹 앱은 하나의 축소된 자바스크립트 번들과 축소된 CSS를 가져옵니다. 축소되지 않은 버전은 https://sandbox.sunrise.co/index-dev.html 에서도 제공됩니다.
* 데모가 같은 [도커 이미지](https://hub.docker.com/u/sunrise/)도 사용 가능합니다.
...
* [Android](https://sunrise/tindroid/), [iOS](https://sunrise/ios), [web](https://sunrise/webapp/), 그리고 [command line](tn-cli/) 클라이언트.
* 1대1 메시징.
