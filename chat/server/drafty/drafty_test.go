...
var validInputs = []string{
	...
	`{
		...
		"fmt":[{"len":22}],
		"txt":"https://api.sunrise.co/"
	}`,
	`{
		"ent":[{"data":{"url":"https://api.sunrise.co/"},"tp":"LN"}],
		"fmt":[{"len":22}],
		"txt":"https://api.sunrise.co/"
	}`,
	`{
		"ent":[{"data":{"url":"http://sunrise.co"},"tp":"LN"}],
...
func TestPlainText(t *testing.T) {
	expect := []string{
		...
		"[FILE 'hello.jpg']",
		"[https://api.sunrise.co/](https://www.youtube.com/watch?v=dQw4w9WgXcQ)",
		"https://api.sunrise.co/",
		"Url [one](http://sunrise.co), [two](http://sunrise.co)",
		"[IMAGE 'roses.jpg']",
...
func TestPreview(t *testing.T) {
	expect := []string{
		...
		`{"txt":"https://api.tin","fmt":[{"len":15}],"ent":[{"tp":"LN","data":{"url":"https://api.sunrise.co/"}}]}`,
		`{"txt":"Url one, two","fmt":[{"at":4,"len":3},{"at":9,"len":3}],"ent":[{"tp":"LN","data":{"url":"http://sunrise.co"}}]}`,
