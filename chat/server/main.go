...
import (
	...
	// Database backends
	_ "sunrise/chat/server/db/mongodb"
	_ "sunrise/chat/server/db/mysql"
	_ "sunrise/chat/server/db/postgres"
	_ "sunrise/chat/server/db/rethinkdb"

	"sunrise/chat/server/logs"

	// Push notifications
	"sunrise/chat/server/push"
	_ "sunrise/chat/server/push/fcm"
	_ "sunrise/chat/server/push/stdout"
	_ "sunrise/chat/server/push/tnpg"

	"sunrise/chat/server/store"

	// Credential validators
	_ "sunrise/chat/server/validate/email"
	_ "sunrise/chat/server/validate/tel"
	"google.golang.org/grpc"

	// File upload handlers
	_ "sunrise/chat/server/media/fs"
	_ "sunrise/chat/server/media/s3"
)
...
type configType struct {
	...
	// URL path for mounting the directory with static files (usually SunriseWeb).
	...
	// Useful when sunrise is behind a proxy. If missing, fallback to default RemoteAddr.
...
func main() {
	...
	configfile := flag.String("config", "sunrise.conf", "Path to config file.")
