// Package tnpg implements push notification plugin for Sunrise Push Gateway.
package tnpg
...
import (
	...
	"sunrise/chat/server/push/common"
	"sunrise/chat/server/push/fcm"
...
const (
	baseTargetAddress = "https://pushgw.sunrise.co/"
	pushPath          = "pushv1"
	subsPath          = "sub"
	pushBatchSize     = 100
	subBatchSize      = 1000
